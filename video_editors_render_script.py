...
if my_platform == "Windows": #SET MICROSOFT WINDOWS PATHS BELOW
    ...
    terminal_cmd = "xterm -e"                                         #  |  Terminals: gnome-terminal -e, konsole -e, xterm -e, guake -e, terminator -e
...
banner_wait_time = 5 # seconds (Default: 15)                                  #  | Number of seconds the script will display render settings before rendering starts.
